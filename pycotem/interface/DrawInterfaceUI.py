...
class Ui_Draw_plane_directions(object):
    def setupUi(self, Draw_plane_directions):
        ...
        self.gridLayout.addWidget(self.plane_entry, 2, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.hexa_Button, 3, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.measure_label, 5, 0, 1, 4)
        ...
        self.proj_image_checkBox = QtGui.QCheckBox(Draw_plane_directions)
        self.proj_image_checkBox.setObjectName(_fromUtf8("proj_image_checkBox"))
        self.gridLayout.addWidget(self.proj_image_checkBox, 4, 0, 1, 1)
        self.scale_checkBox = QtGui.QCheckBox(Draw_plane_directions)
        self.scale_checkBox.setObjectName(_fromUtf8("scale_checkBox"))
        self.gridLayout.addWidget(self.scale_checkBox, 4, 3, 1, 1)
        self.scale_entry = QtGui.QLineEdit(Draw_plane_directions)
        self.scale_entry.setObjectName(_fromUtf8("scale_entry"))
        self.gridLayout.addWidget(self.scale_entry, 4, 2, 1, 1)
    ...
    def retranslateUi(self, Draw_plane_directions):
        ...
        self.proj_image_checkBox.setText(_translate("Draw_plane_directions", "proj. image", None))
        self.scale_checkBox.setText(_translate("Draw_plane_directions", "scale (nm)", None))
