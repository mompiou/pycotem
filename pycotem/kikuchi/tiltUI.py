...
class Ui_Tilt(object):
    def setupUi(self, Tilt):
        ...
        Tilt.setTabOrder(self.tilt_a_entry, self.alpha_signBox)
        Tilt.setTabOrder(self.alpha_signBox, self.tilt_b_entry)
        Tilt.setTabOrder(self.tilt_b_entry, self.beta_signBox)
        Tilt.setTabOrder(self.beta_signBox, self.tilt_z_entry)
        Tilt.setTabOrder(self.tilt_z_entry, self.theta_signBox)
        Tilt.setTabOrder(self.theta_signBox, self.t_ang_entry)
