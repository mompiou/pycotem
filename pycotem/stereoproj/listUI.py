...
class Ui_List(object):
    def setupUi(self, List):
        ...
        self.plane_checkBox = QtGui.QCheckBox(List)
        self.plane_checkBox.setObjectName(_fromUtf8("plane_checkBox"))
        self.gridLayout.addWidget(self.plane_checkBox, 2, 3, 1, 1)
        self.cone_checkBox = QtGui.QCheckBox(List)
        self.cone_checkBox.setObjectName(_fromUtf8("cone_checkBox"))
    ...
    def retranslateUi(self, List):
        ...
        self.plane_checkBox.setText(_translate("List", "plane", None))
        self.cone_checkBox.setText(_translate("List", "cone", None))
