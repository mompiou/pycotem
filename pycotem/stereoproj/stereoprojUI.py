...
class Ui_StereoProj(object):
    def setupUi(self, StereoProj):
        ...
        StereoProj.resize(1404, 920)
        StereoProj.setMinimumSize(QtCore.QSize(0, 920))
        StereoProj.setMaximumSize(QtCore.QSize(16777215, 16777215))
        icon = QtGui.QIcon()
        ...
        self.mplvl.setContentsMargins(-1, 0, 5, 0)
        self.mplvl.setHorizontalSpacing(6)
        ...
        self.ZA_checkBox = QtWidgets.QCheckBox(self.groupBox_2)
        self.ZA_checkBox.setObjectName("ZA_checkBox")
        self.gridLayout_3.addWidget(self.ZA_checkBox, 5, 2, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.trace_cone_button, 7, 0, 1, 2)
        ...
        self.gridLayout_5.addWidget(self.undo_trace_plan_sym_button, 5, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.undo_addpole_button, 2, 3, 1, 1)
        ...
        self.gridLayout_5.addWidget(self.undo_trace_cone_button, 7, 3, 1, 1)
        self.trace_plan_button = QtWidgets.QPushButton(self.groupBox_4)
        self.trace_plan_button.setObjectName("trace_plan_button")
        self.gridLayout_5.addWidget(self.trace_plan_button, 4, 0, 1, 3)
        ...
        self.gridLayout_5.addWidget(self.trace_plan_sym_button, 5, 0, 1, 3)
        ...
        self.gridLayout_10.addWidget(self.text_size_entry, 8, 3, 1, 1)
        self.hexa_button = QtWidgets.QCheckBox(self.groupBox_9)
        self.hexa_button.setObjectName("hexa_button")
        self.gridLayout_10.addWidget(self.hexa_button, 15, 0, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.size_var_label, 7, 0, 1, 3)
        self.uvw_button = QtWidgets.QCheckBox(self.groupBox_9)
        self.uvw_button.setObjectName("uvw_button")
        self.gridLayout_10.addWidget(self.uvw_button, 15, 3, 1, 1)
        self.text_size_label = QtWidgets.QLabel(self.groupBox_9)
        self.text_size_label.setObjectName("text_size_label")
        self.gridLayout_10.addWidget(self.text_size_label, 8, 0, 1, 2)
        self.tilt_angle_entry = QtWidgets.QLineEdit(self.groupBox_9)
        self.tilt_angle_entry.setObjectName("tilt_angle_entry")
        self.gridLayout_10.addWidget(self.tilt_angle_entry, 13, 3, 1, 1)
        self.annotate_checkBox = QtWidgets.QCheckBox(self.groupBox_9)
        self.annotate_checkBox.setObjectName("annotate_checkBox")
        self.gridLayout_10.addWidget(self.annotate_checkBox, 3, 0, 1, 2)
        self.size_var = QtWidgets.QLineEdit(self.groupBox_9)
        self.size_var.setObjectName("size_var")
        self.gridLayout_10.addWidget(self.size_var, 7, 3, 1, 1)
        self.real_space_checkBox = QtWidgets.QCheckBox(self.groupBox_9)
        self.real_space_checkBox.setObjectName("real_space_checkBox")
        self.gridLayout_10.addWidget(self.real_space_checkBox, 9, 0, 1, 2)
        self.labels_entry = QtWidgets.QLineEdit(self.groupBox_9)
        self.labels_entry.setObjectName("labels_entry")
        self.gridLayout_10.addWidget(self.labels_entry, 3, 3, 1, 1)
        self.image_angle_entry = QtWidgets.QLineEdit(self.groupBox_9)
        self.image_angle_entry.setObjectName("image_angle_entry")
        self.gridLayout_10.addWidget(self.image_angle_entry, 14, 3, 1, 1)
        ...
        self.gridLayout_10.addWidget(self.tilt_angle_label, 13, 0, 1, 3)
        ...
        self.gridLayout_2.addWidget(self.alphabetagamma_label, 2, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.d_Slider, 11, 1, 1, 5)
        self.abc_label = QtWidgets.QLabel(self.groupBox)
        self.abc_label.setObjectName("abc_label")
        self.gridLayout_2.addWidget(self.abc_label, 0, 0, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.d_label_var, 12, 1, 1, 5)
        self.search_entry = QtWidgets.QLineEdit(self.groupBox)
        self.search_entry.setObjectName("search_entry")
        self.gridLayout_2.addWidget(self.search_entry, 3, 5, 1, 1)
        self.e_entry = QtWidgets.QLineEdit(self.groupBox)
        self.e_entry.setObjectName("e_entry")
        self.gridLayout_2.addWidget(self.e_entry, 3, 4, 1, 1)
        self.e_label = QtWidgets.QLabel(self.groupBox)
        self.e_label.setObjectName("e_label")
        self.gridLayout_2.addWidget(self.e_label, 3, 0, 1, 3)
        ...
        self.menubar.setGeometry(QtCore.QRect(0, 0, 1404, 25))
        ...
        StereoProj.setTabOrder(self.e_entry, self.search_entry)
        StereoProj.setTabOrder(self.search_entry, self.reciprocal_checkBox)
        ...
        StereoProj.setTabOrder(self.d_Slider, self.lock_checkButton)
        ...
        StereoProj.setTabOrder(self.reset_angle_button, self.color_trace_bleu)
        ...
        StereoProj.setTabOrder(self.wulff_button, self.annotate_checkBox)
        StereoProj.setTabOrder(self.annotate_checkBox, self.labels_entry)
        StereoProj.setTabOrder(self.labels_entry, self.size_var)
        ...
        StereoProj.setTabOrder(self.reset_view_button, self.pole_entry)
        ...
        StereoProj.setTabOrder(self.undo_trace_cone_button, self.simple_checkBox)
        StereoProj.setTabOrder(self.simple_checkBox, self.simple_entry)
        StereoProj.setTabOrder(self.simple_entry, self.norm_button)
        StereoProj.setTabOrder(self.norm_button, self.diff_entry)
        ...
        StereoProj.setTabOrder(self.button_trace, self.ZA_checkBox)
        StereoProj.setTabOrder(self.ZA_checkBox, self.rot_gm_button)
        StereoProj.setTabOrder(self.rot_gm_button, self.rot_g_entry)
        StereoProj.setTabOrder(self.rot_g_entry, self.rot_gp_button)
        StereoProj.setTabOrder(self.rot_gp_button, self.phi1phiphi2_entry)
    ...
    def retranslateUi(self, StereoProj):
        ...
        self.ZA_checkBox.setText(_translate("StereoProj", "ZA"))
        ...
        self.simple_checkBox.setText(_translate("StereoProj", "simple label"))
        ...
        self.annotate_checkBox.setText(_translate("StereoProj", "labels"))
