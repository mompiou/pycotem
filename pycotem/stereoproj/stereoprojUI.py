...
class Ui_StereoProj(object):
    def setupUi(self, StereoProj):
        ...
        self.gridLayout_4.addItem(spacerItem5, 13, 2, 1, 1)
        ...
        StereoProj.setTabOrder(self.dp_button, self.diff_entry)
        ...
        StereoProj.setTabOrder(self.rot_gp_button, self.color_trace_bleu)
        ...
        StereoProj.setTabOrder(self.reset_view_button, self.lock_checkButton)
        ...
        StereoProj.setTabOrder(self.theta_signBox, self.pole_entry)
