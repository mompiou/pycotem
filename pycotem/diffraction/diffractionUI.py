...
class Ui_Diffraction(object):
    def setupUi(self, Diffraction):
        ...
        Diffraction.setTabOrder(self.Button_reset, self.ListBox_d_2)
        Diffraction.setTabOrder(self.ListBox_d_2, self.distance_button)
        ...
        Diffraction.setTabOrder(self.alpha_signBox, self.diff_spot_Listbox)
        Diffraction.setTabOrder(self.diff_spot_Listbox, self.add_spot_button)
        Diffraction.setTabOrder(self.add_spot_button, self.euler_listbox)
